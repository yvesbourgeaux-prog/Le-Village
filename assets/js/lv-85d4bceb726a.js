(function(){const root=window.document.getElementById("lv-85d4bceb726a");if(!root)return;const document=window.lvScopedDocument(root);
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        document.querySelectorAll('#village-vins-events-block .scroll-anim-trigger').forEach(card => {
