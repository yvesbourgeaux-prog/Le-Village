(function(){const root=window.document.getElementById("lv-1ed452825e13");if(!root)return;const document=window.lvScopedDocument(root);
...
document.querySelector('[data-lv-event="h0"]')?.addEventListener("click",function(event){const result=(function(event){toggleSound('fusionVideo', this)}).call(this,event);if(result===false)event.preventDefault();});
document.querySelector('[data-lv-event="h1"]')?.addEventListener("click",function(event){const result=(function(event){toggleVideoPlay('fusionVideo', this)}).call(this,event);if(result===false)event.preventDefault();});
})();